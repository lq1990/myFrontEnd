...
//#endregion
// 使用mock 生成数据
let data=(cov_5v6nz1i4b.s[5]++,Mock.mock({"users|33":[{"id|+1":20000,"name":"@cname","email":"@email","phone":"@natural(13200000,13300000)","address":"@county(true)","zip":"@zip","birthday":"@date('yyyy-MM-dd')"}]}));// es6中的展开运算符 ... 三个点。可以展开运算符、对象、数组。
